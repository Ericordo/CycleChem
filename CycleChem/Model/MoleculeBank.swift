...
class MoleculeBank {
    ...
    init() {
        ...
        let indoline = Molecule(moleculeName: "Indoline", ringSize: 0, ringCount: 2, hasOxygen: false, oxygenCount: 0, hasNitrogen: true, nitrogenCount: 1, hasSulfur: false, sulfurCount: 0, isSaturated: false, image: UIImage(named: "indoline")!)
